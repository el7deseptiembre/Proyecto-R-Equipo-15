...
setwd("~/alfge/2022/BEDU DATA/Módulo 2 y 3/R Studio/Proyecto/Proyecto/Data")
getwd()
...
lista <- lapply(list.files(path = "~/alfge/2022/BEDU DATA/Módulo 2 y 3/R Studio/Proyecto/Proyecto/Data"), read.csv)
